    ...
    <>
      ...
      <div className="md:hidden relative bg-transparent  w-11/12 flex flex-row justify-center items-center py-3 mx-auto">
        <div
          ...
          className="z-[500] absolute top-1/2 left-1 transform -translate-y-1/2"
        >
          <GiHamburgerMenu />
        </div>
        <img src="/new/logo.webp" alt="" className="max-w-20" />
      ...
      {isOpen && (
        <div
          className={`animate__animated animate__slideInDown absolute mt-3 w-11/12 left-5 transform -translate-x-1/2  glass-card duration-700 transition-transform z-50 flex flex-col items-center justify-center p-5`}
        >
          <div
