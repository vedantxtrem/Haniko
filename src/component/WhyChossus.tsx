import { FaShippingFast, FaHive, FaBoxOpen, FaCrown } from 'react-icons/fa'
  ...
  return (
    <section className="w-screen mt-10">
      <div className="w-full flex flex-col justify-center items-center">
        ...
        <div className="w-screen flex justify-evenly items-center gap-5 px-24 ">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col justify-center items-center w-[300px] ">
