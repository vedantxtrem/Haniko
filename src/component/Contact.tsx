...
function Contact() {
  return (
    <section id="contact" className="relative overflow-hidden">
      ...
      <h1
        className={`${poppins.className} text-amber-500 text-4xl sm:text-5xl font-bold text-center mt-28`}
      >
        Contact Us
      </h1>
          ...
          <form className="space-y-4">
            <div className="flex flex-col">
              ...
              <input
                id="name"
                type="text"
                className="border border-gray-300 py-2 px-4 rounded-md transition duration-300 focus:border-pink-500 focus:ring-2 focus:ring-amber-300 outline-none"
            ...
            <div className="flex flex-col">
              ...
              <input
                id="email"
                type="email"
                className="border border-gray-300 py-2 px-4 rounded-md transition duration-300 focus:border-amber-500 focus:ring-2 focus:ring-amber-300 outline-none"
