...
function Page() {
  return (
    <section className={`relative overflow-hidden ${poppins.className}`}>
      ...
      <div className="flex flex-col lg:flex-row gap-16 px-6 lg:px-24 py-16 lg:text-start text-center bg-white">
        {/* Contact Information */}
        <div className='w-full flex border-4 border-amber-500 rounded-r-2xl'>
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start bg-amber-500 text-white p-8 rounded-br-full shadow-xl">
            <img
              ...
              height={0}
              sizes="100vw"
              className="rounded-full h-52 w-52 mb-6 shadow-md bg-white border-4 border-white"
            />
          ...
          <div className="lg:w-1/2 bg-white p-10 rounded-xl ">
